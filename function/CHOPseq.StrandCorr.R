...
CHOPseq.StrandCorr<-function(gr, shift=0, summary.method='weighted.mean') {
# gr				GRanges, tags
...
All<-apply(corr, 1, FUN=function(corr, n, method) CHOPseq.MetaCorr(corr, n, method), n=effective.len, method=summary.method);
